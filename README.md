...
Which retention strategies deliver better long-term value
...
Analyzes churn risk patterns

Identifies high-value and high-risk segments
...
Raw Dataset Layer – Clean structured transactional data

Pivot Analysis Layer – Aggregation and metric computation

Dashboard Layer – Executive-friendly visualization

Why Excel?

Although BI tools exist, Excel was chosen because:

It remains widely used in business environments

PivotTables allow fast aggregation
...
Focus retention budgets on high-frequency customer segments.

Expand personalized email marketing campaigns.

Invest more in high-LTV regions (e.g., North America).

Develop premium loyalty programs targeting electronics buyers.

Align campaign timing with evening peak purchasing behavior.
